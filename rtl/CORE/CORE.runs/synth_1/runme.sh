...
HD_PWD='C:/Users/Ciudad Maderas/Documents/misiri-core/rtl/CORE/CORE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log misiri_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source misiri_top.tcl
